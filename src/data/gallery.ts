...
/** Hero slider (12 imagini curate — AI generate, fișiere locale verificate) */
export const galleryHero: GalleryImage[] = [
    { url: `${BASE}/generated/party_masha_1772697323772.png`, alt: 'Animatori profesioniști SuperParty', category: 'animatori' },
    { url: `${BASE}/generated/party2_bear_1772698449725.png`, alt: 'Animatori pentru copii', category: 'animatori' },
    { url: `${BASE}/generated/party_aurora_1772697306142.png`, alt: 'Elsa, Ana și Olaf la petrecere', category: 'personaje' },
    { url: `${BASE}/generated/party_spiderman_1772697170534.png`, alt: 'Animator Spiderman petreceri', category: 'personaje' },
    { url: `${BASE}/generated/party_tinkerbell_1772697066743.png`, alt: 'Elsa Ana Olaf 2025', category: 'personaje' },
    { url: `${BASE}/generated/party2_belle_1772698205454.png`, alt: 'Arcadă baloane SuperParty', category: 'decor' },
    { url: `${BASE}/generated/party2_pinksequin_1772698747291.png`, alt: 'Decorațiuni baloane', category: 'decor' },
    { url: `${BASE}/generated/party_pumpkin_1772697484876.png`, alt: 'Vată de zahăr la petrecere', category: 'vata-popcorn' },
    { url: `${BASE}/generated/party2_sofia_1772697389928.png`, alt: 'Ursitoare la botez', category: 'ursitoare' },
    { url: `${BASE}/generated/party2_mickey_1772698274288.png`, alt: 'Mickey și Minnie Mouse', category: 'personaje' },
    { url: `${BASE}/generated/party_snow_white_1772697257789.png`, alt: 'Cenușăreasa și Prințul', category: 'animatori' },
    { url: `${BASE}/generated/party2_dragon_1772698409388.png`, alt: 'Baloane cu heliu SuperParty', category: 'decor' },
];

/** Galerie extinsă — animatori + personaje + decor + vată + ursitoare */
export const galleryAll: GalleryImage[] = [
    // ── Animatori — imagini AI (înlocuiesc căile 308→/) ──────────────────────────
    { url: `${BASE}/generated/party_masha_1772697323772.png`, alt: 'Animatori profesioniști', category: 'animatori' },
    { url: `${BASE}/generated/party2_bear_1772698449725.png`, alt: 'Animatori copii distracție', category: 'animatori' },
    { url: `${BASE}/generated/party2_masha_mascot_1772698602775.png`, alt: 'Animatori la domiciliu', category: 'animatori' },
    { url: `${BASE}/generated/party2_mario_1772698389935.png`, alt: 'SuperParty animatori', category: 'animatori' },
    { url: `${BASE}/generated/party_aurora_1772697306142.png`, alt: 'Prințesele Disney la petrecere', category: 'animatori' },
    { url: `${BASE}/generated/party_snow_white_1772697257789.png`, alt: 'Cenușăreasa și Prințul', category: 'animatori' },
    { url: `${BASE}/generated/party2_chase_mascot_1772698662873.png`, alt: 'Mascote petreceri copii București', category: 'animatori' },
    { url: `${BASE}/generated/party_tinkerbell_1772697066743.png`, alt: 'Elsa Ana și Olaf animatori 2025', category: 'animatori' },
    { url: `${BASE}/generated/party2_rocky_mascot_1772698583643.png`, alt: 'Elsa, Ana și Olaf animatori', category: 'animatori' },
    { url: `${BASE}/generated/party2_mickey_1772698274288.png`, alt: 'Mickey și Minnie Mouse animatori', category: 'animatori' },

    // ── Personaje — imagini AI (înlocuiesc căile 308→/) ──────────────────────────
    { url: `${BASE}/generated/party_spiderman_1772697170534.png`, alt: 'Animator Spiderman petreceri', category: 'personaje' },
    { url: `${BASE}/generated/party_spiderman_1772697170534.png`, alt: 'Spiderman la petrecere', category: 'personaje' },
    { url: `${BASE}/generated/party_batman_1772696670487.png`, alt: 'Batman animatori copii', category: 'personaje' },
    { url: `${BASE}/generated/party2_blackcat_1772698166362.png`, alt: 'Superman petreceri copii', category: 'personaje' },
    { url: `${BASE}/generated/party2_bumblebee_1772698238726.png`, alt: 'Testoasele Ninja', category: 'personaje' },
    ...
    // ── Mascot complet + costume noi — imagini AI (25) ──────────────────────────
    { url: `${BASE}/generated/party2_mario_1772698389935.png`, alt: 'Mario la petrecere copii joc', category: 'personaje' },
    { url: `${BASE}/generated/party2_dragon_1772698409388.png`, alt: 'Dragon mascot la petrecere copii magie', category: 'personaje' },
    { url: `${BASE}/generated/party2_bear_1772698449725.png`, alt: 'Urs mascot la petrecere copii drăguț', category: 'personaje' },
    { url: `${BASE}/generated/party2_jerry_mascot_1772698466619.png`, alt: 'Jerry mascot complet la petrecere copii', category: 'personaje' },
    { url: `${BASE}/generated/party2_luigi_mascot_1772698483601.png`, alt: 'Luigi mascot complet la petrecere Mario', category: 'personaje' },
    { url: `${BASE}/generated/party2_marshall_mascot_1772698515212.png`, alt: 'Marshall PAW Patrol mascot la petrecere', category: 'personaje' },
    { url: `${BASE}/generated/party2_skye_1772698531817.png`, alt: 'Skye PAW Patrol la petrecere fetite', category: 'personaje' },
    { url: `${BASE}/generated/party2_rubble_1772698548467.png`, alt: 'Rubble PAW Patrol constructie petrecere', category: 'personaje' },
    { url: `${BASE}/generated/party2_rocky_mascot_1772698583643.png`, alt: 'Rocky PAW Patrol mascot petrecere', category: 'personaje' },
    { url: `${BASE}/generated/party2_masha_mascot_1772698602775.png`, alt: 'Masha mascot complet la petrecere copii', category: 'personaje' },
    { url: `${BASE}/generated/party2_tom_mascot_1772698618846.png`, alt: 'Tom Cat mascot complet la petrecere', category: 'personaje' },
    { url: `${BASE}/generated/party2_chase_mascot_1772698662873.png`, alt: 'Chase PAW Patrol politist petrecere copii', category: 'personaje' },
    { url: `${BASE}/generated/party2_unicorn_mascot_1772698679517.png`, alt: 'Unicorn mascot complet la petrecere magica', category: 'personaje' },
    { url: `${BASE}/generated/party2_eskimo_1772698696420.png`, alt: 'Personaj iarna la petrecere zapada', category: 'personaje' },
    { url: `${BASE}/generated/party2_mickey_full_1772698730320.png`, alt: 'Mickey Mouse mascot la petrecere Disney', category: 'personaje' },
    { url: `${BASE}/generated/party2_pinksequin_1772698747291.png`, alt: 'Animatoare rochie roz sclipici petrecere', category: 'personaje' },
    { url: `${BASE}/generated/party2_reddress_1772698763280.png`, alt: 'Animatoare rochie rosie petrecere vesela', category: 'personaje' },
    { url: `${BASE}/generated/party2_blackcat_1772698166362.png`, alt: 'Black Cat Marvel petrecere supereroina', category: 'personaje' },
    { url: `${BASE}/generated/party2_peterpan_1772698184131.png`, alt: 'Peter Pan aventura Tara de Nicaieri petrecere', category: 'personaje' },
    { url: `${BASE}/generated/party2_belle_1772698205454.png`, alt: 'Belle Frumoasa si Bestia petrecere printesa', category: 'personaje' },
    { url: `${BASE}/generated/party2_bumblebee_1772698238726.png`, alt: 'Bumblebee Transformers petrecere baieti', category: 'personaje' },
    { url: `${BASE}/generated/party2_jasmine2_1772698255180.png`, alt: 'Printesa Jasmine petrecere Aladdin', category: 'personaje' },
    { url: `${BASE}/generated/party2_mickey_1772698274288.png`, alt: 'Mickey Mouse petrecere Disney copii', category: 'personaje' },
    { url: `${BASE}/generated/party2_sonic_mascot_1772698311287.png`, alt: 'Sonic mascot petrecere copii rapid', category: 'personaje' },
    { url: `${BASE}/generated/party2_bluedress_1772698325808.png`, alt: 'Animatoare rochie albastra petrecere printesa', category: 'personaje' },
